            ...
            <div class="bg-white dark:bg-gray-800 shadow-xl sm:rounded-lg p-6">
                ...
                <form action="{{ route('messages.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="sender" id="sender" class="w-full px-4 py-2 border border-gray-300 rounded-md" required>
                    </div>

                    <div class="mb-4">
                        <label for="role" class="block text-sm text-gray-700 dark:text-gray-300">Role</label>
                        <input type="text" name="role" id="role" class="w-full px-4 py-2 border border-gray-300 rounded-md" required>
                    </div>

                    <div class="mb-4">
                        <label for="subject" class="block text-sm text-gray-700 dark:text-gray-300">Subject</label>
                        <input type="text" name="subject" id="subject" class="w-full px-4 py-2 border border-gray-300 rounded-md" required>
                    </div>

                    <div class="mb-4">
                        <label for="content" class="block text-sm text-gray-700 dark:text-gray-300">Message Content</label>
                        <textarea name="content" id="content" rows="4" class="w-full px-4 py-2 border border-gray-300 rounded-md" required></textarea>
                    </div>
